    ...
    <div className="min-h-screen flex flex-col bg-gray-900 text-white">
      ...
      <motion.section {...pageTransition} className="container mx-auto p-6 text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-6">
          {["HTML5", "CSS3", "React.js", "Tailwind CSS", "Node.js (Express.js)", "C# (WinForms)","Python (FastAPI, Flask)", "RESTful APIs", "SQL Server", "PostgreSQL", "MongoDB", "Docker", "Redis", "Git & GitHub", "Crystal Reports (Report Design & Integration)"].map(skill => (
