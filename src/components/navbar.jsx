...
function Navbar() {
  ...
  return (
    <>
        <div className='bg-gray-500 sticky top-0 py-3 px-4 shadow md:flex md:item-center md:justify-between relative z-10'>
            <div className='flex justify-between items-center'>
                <a href="/"><span className='font-bold text-2xl lg:text-3xl text-white'>ALI PETER</span></a>
            ...
            <ul className={`md:flex md:items-center z-[-1] md:z-auto md:static absolute
                bg-[#000] md:bg-black/0 w-full left-0 md:w-auto md:py-0 py-4 
                ...
                <li className='mx-4 md:mx-2 mt-10 md:my-0 md:px-2 md:hover:bg-gray-900 rounded-full'>
                    <Link to="/" className="text-xl text-white hover:text-gray-500 duration-500">HOME</Link>
                </li>
                <li className='mx-4 md:mx-2 my-8 md:my-0 md:px-2 md:hover:bg-gray-900 rounded-full'>
                ...
                <button className='bg-gray-500 font-[Poppins] duration-500 px-4 py-2 md:mx-2 md:hover:bg-gray-900 text-white rounded-full'>
