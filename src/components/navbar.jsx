        ...
        <div className='bg-black/70 py-3 px-4 shadow md:flex md:item-center md:justify-between relative z-10'>
            ...
            <ul className={`md:flex md:items-center z-[-1] md:z-auto md:static absolute
                ...
                <li className='mx-4 mt-10 md:my-0'>
                    <Link className="text-xl text-white hover:text-gray-500 duration-500">HOME</Link>
                </li>
                <li className='mx-4 my-8 md:my-0'>
                    <Link className="text-xl text-white hover:text-gray-500 duration-500">WORK</Link>
                </li>
                <li className='mx-4 my-8 md:my-0'>
                    <Link className="text-xl text-white hover:text-gray-500 duration-500">BLOGS</Link>
                </li>
                <li className='mx-4 my-8 md:my-0'>
                    <Link className="text-xl text-white hover:text-gray-500 duration-500">ABOUT</Link>
                </li>
