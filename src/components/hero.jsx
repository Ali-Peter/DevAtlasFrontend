...
const Hero = () => {
    useEffect(() => {
        ...
        const text1 = new SplitType('#text1', {types: 'words'});

        text.lines.forEach((char, index) => {
            char.style.animationDelay = `${index * 0.5}s`;
            char.classList.add('animated-char');
        }, []);
        text1.words.forEach((char, index) => {
            char.style.animationDelay = `${index * 0.5}s`;
            char.classList.add('animated-char');
        }, []);
    })
            ...
            <div className='md:flex my-8 px-5 mx-auto md:mx-16 text-[#000]'>
                ...
                <div className='md:basis-2/4 md:h-screen custom-scrollbar mt-24 md:mt-0'>
                    <div className='md:text-center'>
                        <h1 id='text1' className='lg:text-[80px] md:my-12 my-2 uppercase text-[50px] font-bold leading-none'>Full Stack Developer</h1>
                    </div>
                    <div className='flex uppercase my-16'>
                        <div className='basis-1/5'>
                            <span className='text-[30px]'>01</span>
                        </div>
                        <div className='basis-4/5 text-[16px] font-bold'>
