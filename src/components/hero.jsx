        ...
        <div className="relative h-full overflow-hidden">
            ...
            <div className='md:flex my-8 px-5 pb-5 mx-auto md:mx-16 text-[#000] relative z-2'>
                ...
                <div className='md:basis-2/4 md:h-screen custom-scrollbar mt-24 md:mt-0'>
                        <div>
                            ...
                            <div className='flex uppercase my-16'>
                                ...
                                <div  id='professionText' className='basis-4/5 text-[16px] font-bold'>
                                    ...
                                    <Number>
                                        <Link to="/about" className='text-[16px] text-blue-500 hover:underline'>more about me and services</Link>
                                    </Number>
                                </div>
                            </div>
                        </div>
                                    ...
                                    {skillItem.map((item, index) => (
                                        <Number>
                                            <div key={index} className='flex border border-[#000] rounded-full p-2 m-2'>
                                                <img src={item.skillImg} alt="Django Logo" className="mr-2 md:h-6 md:w-6 w-5 h-5" />
                                                <h4 className="md:text-sm text-xs text-[#000]">{item.skillName}</h4>
                                            </div>
                                        </Number>
                                    ))}
                                </div>
                            ...
                            <div className='basis-4/5 mt-3'>
                                    <div>
                                        ...
                                        <span className='grid grid-cols-3'>
                                            <Number>
                                                <h4 className="md:text-sm text-xs text-center mr-2 mt-2 border border-[#000] rounded-full md:px-2 px-1 text-[#000]">ReactJS</h4>
                                            </Number>
                                            <Number>
                                                <h4 className="md:text-sm text-xs text-center mr-2 mt-2 border border-[#000] rounded-full md:px-2 px-1 text-[#000]">NodeJS</h4>
                                            </Number>
                                            <Number>
                                                <h4 className="md:text-sm text-xs text-center mr-2 mt-2 border border-[#000] rounded-full md:px-2 px-1 text-[#000]">Tailwind css</h4>
                                            </Number>
                                            <Number>
                                                <h4 className="md:text-sm text-xs text-center mr-2 mt-2 border border-[#000] rounded-full md:px-2 px-1 text-[#000]">Axios</h4>
                                            </Number>
                                        </span>
                                    </div>
                                    <div className='mt-16'>
                                        ...
                                        <span className='grid grid-cols-3'>
                                            ...
                                            <Number>
                                                <h4 className="md:text-sm text-xs text-center mr-2 mt-2 border border-[#000] rounded-full md:px-2 px-1 text-[#000]">Mongoose</h4>
                                            </Number>
                                            <Number>
                                                <h4 className="md:text-sm text-xs text-center mr-2 mt-2 border border-[#000] rounded-full md:px-2 px-1 text-[#000]">ExpressJS</h4>
                                            </Number>
                                            <Number>
                                                <h4 className="md:text-sm text-xs text-center mr-2 mt-2 border border-[#000] rounded-full md:px-2 px-1 text-[#000]">Tailwind css</h4>
                                            </Number>
                        ...
                        <Number>
                            <Link to="/work" className='text-[16px] text-blue-500 hover:underline'>Visit my project hub</Link>
                        </Number>
                        </div>
                </div>
            </div>
